...
// Safaricom public certificates (RSA public keys) used to encrypt the
// initiator password into a SecurityCredential. Embedded at build time so
// the package works from source and from dist without extra files.
const CERTIFICATES: Record<MpesaEnvironment, string> = {
  sandbox: `-----BEGIN CERTIFICATE-----
