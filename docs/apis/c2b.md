...
> **Status:**  **Simulate** is  verified against the sandbox in all three SDKs. **Register URL** is implemented per the docs but the sandbox WAF blocks the endpoint for some accounts (`Service is currently unreachable` / `500`).
