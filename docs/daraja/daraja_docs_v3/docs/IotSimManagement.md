...
| Field | Value |
| --- | --- |
| vpnGroup | 1-555162310488\_VPN |
| msisdns | 0110100606, 0110100607 |
| username | [darajasandbox@safaricom.co.ke](mailto:darajasandbox@safaricom.co.ke) |
...
2. Create a new [sandbox app](https://developer.safaricom.co.ke/dashboard/myapps) using this naming format: Prod-companyname-IOT-1778847243655.
3. After creating the app, send an email to [apisupport@safaricom.co.ke](mailto:apisupport@safaricom.co.ke) requesting the sandbox app to be whitelisted for production access.

#### Note

1778847243655 is the current Unix timestamp in milliseconds and is used to keep the app name unique.
