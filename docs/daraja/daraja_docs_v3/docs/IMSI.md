# IMSI
**Source:** https://developer.safaricom.co.ke/apis/IMSI

---

[![safaricom logo](../images/IMSI_img_0.svg)](/)
...
| responseCode | A Numeric status code that indicates the status of the transaction submission. 200 means successful submission | Numeric | 200 |
...
| imsi | This is the hashed number representing the international mobile subscriber identity i.e imsi | Numerical | 4213215110021315 |
...
| msisdnRegistrationDate | Represents the MSISDN registration date on the network or a message depicting that the MSISDN registration is more than one year old. | String | 2019-01-12 |
| customerNumber | The customer MSISDN whose network age is to be determined | Numeric | 254722001231 |
